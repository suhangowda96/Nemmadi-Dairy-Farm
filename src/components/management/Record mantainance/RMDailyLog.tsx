...
import { 
  Plus, Calendar, FileText, FileSpreadsheet, Search, 
  Edit, X, Filter, ChevronDown, ChevronUp, ClipboardList, 
  Download, Trash2, Check, CheckCircle, User, UserCheck
} from 'lucide-react';
...
interface RMDailyLogProps {
  query?: string;
}

const RMDailyLog: React.FC<RMDailyLogProps> = ({ query = '' }) => {
  const { user } = useAuth();
  ...
  const exportToExcel = async () => {
    try {
      ...
      if (response.ok) {
        ...
        a.href = downloadUrl;
        a.download = `rm_daily_logs_${new Date().toISOString().slice(0, 10)}.xlsx`;
  ...
  const handleDelete = async (id: number) => {
    if (window.confirm('Are you sure you want to delete this daily log? This action cannot be undone.')) {
      try {
        setDeletingId(id);
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div className="text-center sm:text-left">
              <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">RM Daily Logs</h1>
            </div>
            {showAddButton && (
            <button
            ...
            >
              ...
              <div className="p-4 lg:p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Maintained By *</label>
                      <input
                        type="text"
                        name="maintained_by"
                        ...
                        onChange={handleChange}
                        required
                        placeholder="Name of maintainer"
                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                      />
                    </div>
                    <div>
                      ...
                      <div className="flex space-x-4 mt-2">
                        ...
                        <label className="inline-flex items-center">
                          <input
                            ...
                            name="format"
                            value="Register"
                            checked={formData.format === 'Register'}
                            onChange={handleRadioChange}
                            className="h-4 w-4 text-blue-600"
                          />
                          <span className="ml-2 flex items-center">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={4}
                      placeholder="Additional remarks about the record"
            ...
            <>
                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Maintained By</th>
                    ...
                    {filteredRecords.map((record) => (
                      <tr key={record.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <div className="text-sm text-gray-900">{record.record_type}</div>
                        </td>
                        <td className="px-4 py-3">
                          <div className="flex items-center">
                            <User className="w-4 h-4 text-blue-500 mr-2" />
                            <span className="text-sm text-gray-900">{record.maintained_by}</span>
                          </div>
                        </td>
                        <td className="px-4 py-3">
                          <div className="flex items-center">
                  ...
                  >
                    ...
                    <div className="p-4 grid grid-cols-1 gap-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <h3 className="text-xs font-semibold text-gray-500 uppercase mb-1">Maintained By</h3>
                          <div className="flex items-center">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <h3 className="text-xs font-semibold text-gray-500 uppercase mb-1">Checked By</h3>
                          <div className="flex items-center">
              ...
              {filteredRecords.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-lg mb-2">No daily logs found</p>
