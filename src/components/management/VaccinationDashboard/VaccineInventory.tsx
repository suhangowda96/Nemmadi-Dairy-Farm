...
import { 
  ...
  Package, Syringe, Activity, AlertTriangle, Box
} from 'lucide-react';
...
const VaccineInventory: React.FC<VaccineInventoryProps> = ({ query = '' }) => {
  const { user } = useAuth();
  ...
  const exportToExcel = async () => {
    try {
      ...
      if (response.status === 200) {
        ...
        a.href = downloadUrl;
        a.download = `vaccine_inventory_${new Date().toISOString().slice(0, 10)}.xlsx`;
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div className="text-center sm:text-left">
              <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Vaccine Inventory</h1>
              <p className="text-gray-600 mt-1">Track vaccine stock by batch and expiration</p>
            </div>
          ...
          <div className="p-4 lg:p-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search by vaccine or batch..."
                  value={searchTerm}
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="p-4 lg:p-6 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              <h2 className="text-xl font-bold text-gray-900">Vaccine Inventory Records</h2>
              <div className="flex items-center space-x-3">
            ...
            <>
                    ...
                    <div className="p-4 grid grid-cols-2 gap-4">
                      <div className="col-span-2">
                        <div className="flex items-center justify-between">
                          <h3 className="text-lg font-bold text-gray-900">{record.vaccine_name || 'N/A'}</h3>
                        </div>
                      </div>
              ...
              {filteredRecords.length === 0 && !isLoading && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-lg mb-2">No vaccine inventory records found</p>
