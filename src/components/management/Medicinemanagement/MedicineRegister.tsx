...
const MedicineRegister: React.FC<MedicineRegisterProps> = ({ query = '' }) => {
  const { user } = useAuth();
  ...
  const fetchRecords = async () => {
    try {
      ...
      let url = `https://nemmadi-dairy-farm.koyeb.app/api/medicines-register/${query}`;
      ...
      if (response.ok) {
        ...
        setError('Failed to fetch medicine records');
      }
    } catch (err) {
  ...
  const calculateTotals = () => {
    ...
    filteredRecords.forEach(record => {
      totals.totalMedicines += parseInt(record.quantity_received) || 0;
  ...
  const exportToExcel = async () => {
    try {
      ...
      let url = 'https://nemmadi-dairy-farm.koyeb.app/api/medicines-register/export/';
      const params = new URLSearchParams();
      ...
      if (response.ok) {
        ...
        a.href = downloadUrl;
        a.download = `medicine_register_${new Date().toISOString().slice(0, 10)}.xlsx`;
        document.body.appendChild(a);
        a.click();
        a.remove();
        window.URL.revokeObjectURL(downloadUrl);
      } else {
        setError('Failed to export medicine data');
      }
    } catch (err) {
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div className="text-center sm:text-left">
              <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Medicine Register</h1>
              <p className="text-gray-600 mt-1">Tracking of medicine inventory and status</p>
            </div>
          ...
          <div className="p-4 lg:p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search by medicine name, batch or PO..."
                  value={searchTerm}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 flex items-center space-x-3 border-l-4 border-blue-500">
            ...
            <div>
              ...
              <p className="text-lg font-bold">{formatIndianNumber(totals.totalMedicines)} units</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="p-4 lg:p-6 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              <h2 className="text-xl font-bold text-gray-900">Medicine Register Records</h2>
              <div className="flex items-center space-x-3">
          ...
          {isLoading ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">Loading medicine records...</p>
            </div>
          ) : error ? (
                      ...
                      <div className="p-4 grid grid-cols-1 gap-4">
                        ...
                        <div className="col-span-1">
                          <div className="flex items-start">
                            ...
                            <div className="ml-3">
                              <h3 className="text-xs font-semibold text-gray-500 uppercase">Medicine Name</h3>
                              <p className="text-sm font-medium">{record.medicine_name || 'N/A'}</p>
                            </div>
                          </div>
                        </div>
