...
import { 
  ...
  Milk, Palette, Thermometer, Filter as FilterIcon, CloudRain
} from 'lucide-react';
...
interface MQCCollectionQualityProps {
  query?: string;
}

const MQCCollectionQuality: React.FC<MQCCollectionQualityProps> = ({ query = '' }) => {
  const { user } = useAuth();
  ...
  const exportToExcel = async () => {
    try {
      ...
      if (response.ok) {
        ...
        a.href = downloadUrl;
        a.download = `mqc_collection_${new Date().toISOString().slice(0, 10)}.xlsx`;
  ...
  const handleDelete = async (id: number) => {
    if (window.confirm('Are you sure you want to delete this milk collection record? This action cannot be undone.')) {
      try {
        setDeletingId(id);
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div className="text-center sm:text-left">
              <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Milk Collection Quality</h1>
              <p className="text-gray-600 mt-1">Monitor and manage milk quality at collection</p>
            </div>
            {showAddButton && (
            <button
              ...
              <div className="sticky top-0 bg-white border-b border-gray-200 p-4 lg:p-6 rounded-t-xl">
                <div className="flex justify-between items-center">
                  <h2 className="text-xl font-bold text-gray-900">
                    {editingRecord ? 'Edit Milk Collection Record' : 'Add Milk Collection Record'}
                  </h2>
                  <button
                    onClick={() => {
                      setShowForm(false);
              ...
              <div className="p-4 lg:p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Milking Time *</label>
                      <input
                        type="time"
                        name="milking_time"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3 text-sm">
                        <label htmlFor="suspended_particles" className="font-medium text-gray-700">
                          Suspended Particles
                        </label>
                        <p className="text-gray-500">Visible particles in milk</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-3 text-sm">
                        <label htmlFor="filtered" className="font-medium text-gray-700">
                          Filtered
                        </label>
                        <p className="text-gray-500">Milk has been filtered</p>
                      </div>
                    </div>
                  </div>
            ...
            <>
                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Milk Color</th>
                    ...
                    {filteredRecords.map((record) => (
                      <tr key={record.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center">
                            <span className="text-sm text-gray-900">{record.milking_time}</span>
                          </div>
                        </td>
                        <td className="px-4 py-3">
                          <div className="flex items-center">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center">
                            <CloudRain className="w-4 h-4 text-green-400 mr-2" />
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center">
                            <FilterIcon className="w-4 h-4 text-orange-400 mr-2" />
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center">
                            <FilterIcon className="w-4 h-4 text-purple-500 mr-2" />
                            <span className="text-sm text-gray-900">
                  ...
                  >
                    <div className="p-4 bg-blue-50 border-b border-blue-100 flex justify-between items-center">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-600">• {record.milking_time}</span>
                      </div>
                      {isSupervisor && (
                      <div className="flex space-x-2">
                        <button
                    ...
                    <div className="p-4 grid grid-cols-2 gap-4">
                      <div className="flex items-start">
                        <Milk className="w-5 h-5 text-blue-400 mt-0.5 flex-shrink-0" />
                        <div className="ml-3">
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          <h3 className="text-xs font-semibold text-gray-500 uppercase">Milk Color</h3>
                          <p className="text-sm font-medium text-gray-900">
                            {record.milk_color}
                          </p>
                        </div>
                      ...
                      <div className="flex items-start">
                        <CloudRain className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                        <div className="ml-3">
                      ...
                      <div className="flex items-start">
                        <FilterIcon className="w-5 h-5 text-orange-400 mt-0.5 flex-shrink-0" />
                        <div className="ml-3">
                      ...
                      <div className="flex items-start">
                        <FilterIcon className="w-5 h-5 text-purple-500 mt-0.5 flex-shrink-0" />
                        <div className="ml-3">
              ...
              {filteredRecords.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-lg mb-2">No milk collection records found</p>
...
export default MQCCollectionQuality;