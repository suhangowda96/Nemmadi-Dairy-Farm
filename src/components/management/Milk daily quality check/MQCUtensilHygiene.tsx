...
import { 
  ...
  SprayCan, Check, XCircle, User, ClipboardCheck
} from 'lucide-react';
...
interface MQCUtensilHygieneProps {
  query?: string;
}

const MQCUtensilHygiene: React.FC<MQCUtensilHygieneProps> = ({ query = '' }) => {
  const { user } = useAuth();
  ...
  const filteredRecords = records.filter(record => {
    ...
    const matchesSearch = searchTerm === '' || 
      ...
      record.cleaning_agent?.toLowerCase().includes(searchTerm.toLowerCase()) ||
      record.cleaned_by?.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const exportToExcel = async () => {
    try {
      ...
      if (response.ok) {
        ...
        a.href = downloadUrl;
        a.download = `utensil_hygiene_${new Date().toISOString().slice(0, 10)}.xlsx`;
  ...
  const handleDelete = async (id: number) => {
    if (window.confirm('Are you sure you want to delete this utensil hygiene record? This action cannot be undone.')) {
      try {
        setDeletingId(id);
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div className="text-center sm:text-left">
              <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Utensil Hygiene</h1>
              <p className="text-gray-600 mt-1">Monitor and manage utensil cleaning and sanitation</p>
            </div>
            {showAddButton && (
            <button
          ...
          <div className="p-4 lg:p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search by item, agent, or cleaner..."
                  value={searchTerm}
            ...
            >
              <div className="sticky top-0 bg-white border-b border-gray-200 p-4 lg:p-6 rounded-t-xl">
                <div className="flex justify-between items-center">
                  <h2 className="text-xl font-bold text-gray-900">
                    {editingRecord ? 'Edit Utensil Hygiene Record' : 'Add Utensil Hygiene Record'}
                  </h2>
                  <button
                    onClick={() => {
                      setShowForm(false);
              ...
              <div className="p-4 lg:p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3 text-sm">
                        <label htmlFor="cleaned" className="font-medium text-gray-700">
                          Cleaned
                        </label>
                        <p className="text-gray-500">Item was cleaned</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-3 text-sm">
                        <label htmlFor="sanitized" className="font-medium text-gray-700">
                          Sanitized
                        </label>
                        <p className="text-gray-500">Item was sanitized</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Cleaning Agent *</label>
                      <input
                        type="text"
                        name="cleaning_agent"
                        ...
                        onChange={handleChange}
                        required
                        placeholder="e.g., Detergent, Sanitizer"
                        className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={3}
                      placeholder="Additional notes about utensil hygiene"
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="p-4 lg:p-6 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
              <h2 className="text-xl font-bold text-gray-900">Utensil Hygiene Records</h2>
            ...
            <>
                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Sanitized</th>
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Cleaning Agent</th>
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Cleaned By</th>
                    ...
                    {filteredRecords.map((record) => (
                      <tr key={record.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center">
                            <SprayCan className="w-4 h-4 text-blue-500 mr-2" />
                            <span className="text-sm text-gray-900">{record.item}</span>
                          </div>
                        </td>
                        <td className="px-4 py-3">
                          <div className="flex items-center">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm text-gray-900">{record.cleaning_agent}</span>
                          </div>
                        </td>
                        <td className="px-4 py-3">
                          <div className="flex items-center">
                            <User className="w-4 h-4 text-orange-500 mr-2" />
                            <span className="text-sm text-gray-900">{record.cleaned_by}</span>
                          </div>
                        </td>
                  ...
                  >
                    ...
                    <div className="p-4 grid grid-cols-2 gap-4">
                      <div className="flex items-start">
                        <SprayCan className="w-5 h-5 text-blue-500 mt-0.5 flex-shrink-0" />
                        <div className="ml-3">
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          <h3 className="text-xs font-semibold text-gray-500 uppercase">Cleaning Agent</h3>
                          <p className="text-sm font-medium text-gray-900">
                            {record.cleaning_agent}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          <h3 className="text-xs font-semibold text-gray-500 uppercase">Cleaned By</h3>
                          <p className="text-sm font-medium text-gray-900">
                            {record.cleaned_by}
                          </p>
                        </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          <h3 className="text-xs font-semibold text-gray-500 uppercase">Cleaned</h3>
                          <p className="text-sm font-medium text-gray-900">
                            {record.cleaned ? 'Yes' : 'No'}
                          </p>
                        </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          <h3 className="text-xs font-semibold text-gray-500 uppercase">Sanitized</h3>
                          <p className="text-sm font-medium text-gray-900">
                            {record.sanitized ? 'Yes' : 'No'}
                          </p>
                        </div>
              ...
              {filteredRecords.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 text-lg mb-2">No utensil hygiene records found</p>
...
export default MQCUtensilHygiene;